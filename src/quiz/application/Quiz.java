...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        opt1.setBackground(new Color(246, 253, 195));
        opt1.setFont(new Font("Dialog", Font.PLAIN, 20));
        add(opt1);
        
        opt2 = new JRadioButton();
        opt2.setBounds(170, 510, 700, 30);
        opt2.setBackground(new Color(246, 253, 195));
        opt2.setFont(new Font("Dialog", Font.PLAIN, 20));
        add(opt2);
        
        opt3 = new JRadioButton();
        opt3.setBounds(170, 540, 700, 30);
        opt3.setBackground(new Color(246, 253, 195));
        opt3.setFont(new Font("Dialog", Font.PLAIN, 20));
        add(opt3);
        
        opt4 = new JRadioButton();
        opt4.setBounds(170, 570, 700, 30);
        opt4.setBackground(new Color(246, 253, 195));
        ...
        next.setBounds(960, 550, 200, 40);
        next.setFont(new Font("Mongolian Baiti", Font.BOLD, 25));
        next.setBackground(new Color(44,120,101));
    ...
    public void paint(Graphics g) {
        ...
        if (timer > 0) { 
            g.drawString(time, 1000, 440);
        } else {
            g.drawString("Times up!!", 1000, 440);
        }
